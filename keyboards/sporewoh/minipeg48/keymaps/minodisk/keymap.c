...
[_MAC] = LAYOUT_ortho_4x12(
  ...
  KC_SPC,  MA_PRSC, MA_EMO, LALT_T(KC_LNG1), LGUI_T(KC_BSPC), LT(_LOWER, KC_ESC), LT(_RAISE, KC_ENT), RCTL_T(KC_SPC), RSFT_T(KC_LNG2), KC_F22, KC_F23,  KC_F24 
),
...
[_LOWER] = LAYOUT_ortho_4x12(
  ...
  _______,    HYPR(KC_A), HYPR(KC_S), HYPR(KC_D), HYPR(KC_F), HYPR(KC_G), KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   _______,    _______,
  _______,    HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_V), HYPR(KC_B), HYPR(KC_N), HYPR(KC_M), KC_LBRC,    KC_RBRC,    _______,    _______,
