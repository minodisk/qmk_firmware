...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE0] = LAYOUT(
    ...
    _______, _______, _______, _______, _______,   G_SPC,         G_SPC, _______, _______, _______, _______, _______
  ), 
  [_RAISE1] = LAYOUT(
    /* Left */                                                  /* Right */
 A(KC_TILD), KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,       KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,  KC_EQL,
    ...
    _______, _______, _______, _______, _______,   A_SPC,         A_SPC, _______, _______, _______, _______, _______
  ), 
};
